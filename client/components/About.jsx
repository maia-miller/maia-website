  ...
  <div className='about'>
    <div className='hero'>
      ...
      <div className='columns'>
        ...
        <h5 className='subtitle is-5'><strong>Team player</strong></h5>
        ...
        <div className='column'>
          <figure className="image is-128x128 symbol" data-aos="zoom-in" data-aos-duration="600" data-aos-delay="250">
            <img src="../images/problemsolve.png" />
          </figure>
          <h5 className='subtitle is-5'><strong>Problem Solver</strong></h5>
        ...
        <div className='column'>
          <figure className="image is-128x128 symbol" data-aos="zoom-in" data-aos-duration="600" data-aos-delay="300">
            <img src="../images/fastlearner.png" />
          </figure>
          <h5 className='subtitle is-5'><strong>Fast Learner</strong></h5>
        ...
        <div className='column'>
          ...
          <h5 className='subtitle is-5'><strong>An Eye on Growth</strong></h5>
