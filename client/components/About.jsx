  ...
  <div className='about'>
    ...
    <div className='columns'>
      <div className='column'>
        ...
        {/* <img className='"col-figure image is-128x128 symbol" data-aos="zoom-in" data-aos-duration="600" data-aos-delay="200" col-img' src="../images/teamwork.png" /> */}
        <h3 className='subject-title'><strong>Team player</strong></h3>
      ...
      <div className='column'>
        <div className='purple-block'></div>
        {/* <img className='col-figure image is-128x128 symbol" data-aos="zoom-in" data-aos-duration="600" data-aos-delay="250" col-img' src="../images/problemsolve.png" /> */}
      ...
      <div className='column'>
        <div className='purple-block'></div>
        {/* <img className='col-figure image is-128x128 symbol" data-aos="zoom-in" data-aos-duration="600" data-aos-delay="300" col-img' src="../images/fastlearner.png" /> */}
      ...
      <div className='column'>
        <div className='purple-block'></div>
        {/* <img className='col-figure image is-128x128 symbol" data-aos="zoom-in" data-aos-duration="600" data-aos-delay="350" col-img' src="../images/chart.png" /> */}
